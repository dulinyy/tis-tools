...
class CMolecularSystem {
  private:
    ...
    double get_NumberFromBond(int,int,int);
    ...
    //int clusterCriterium2(int,int);
    //int clusterCriterium3(int,int);
    //the cluster structure criterium, "Is this particle in hcp, bcc, fcc or liquid?"
    int fccclusterCriterium(int);
    int bccclusterCriterium(int);
    int hcpclusterCriterium(int);
    int liqclusterCriterium(int,int);
    int nonstructCriterium(int);
   //get distance between two particles with nearest image
    ...
    double normaq46Histo3d[OrderParameterHistoSize][OrderParameterHistoSize];
    double bccnormaq46Histo3d[OrderParameterHistoSize][OrderParameterHistoSize];
    double fccnormaq46Histo3d[OrderParameterHistoSize][OrderParameterHistoSize];
    double hcpnormaq46Histo3d[OrderParameterHistoSize][OrderParameterHistoSize];
    double liqnormaq46Histo3d[OrderParameterHistoSize][OrderParameterHistoSize];
  ...
  public:
    ...
    void readParticleFile(const string&);
    void readcrystalHistogramFiles();
    void readLiquidHistogramFile();
    ...
    //calcultat largest cluster parameter 
    void calculate_largestClusterparameter();
    ...
    void get_systemstructureparameters();
    int get_skinparameters(int&);
    //update the q4Histo,...
