...
const string INFILESTRING = "COMMANDLINE";
const double PI = 3.14159265;
const int OrderParameterHistoSize = 1000;
const double OrderParameterHistoStart = 0.0;
const double  OrderParameterHistoStop = 0.65;
...
class CParameter {
  ...
  public:
    ...
    int nop;
    int baseunit;
    //Frankel criterium for solidlike particles
    int minfrenkel;
    //Number of Cells
    int noc;
    //Boxsize x and y
