...
int CMolecularSystem::bccclusterCriterium(int ti,int criterium)
{
  //double a,b;
  //int n;
  int value;
  ...
  if (criterium == 0)
  {
    if ((this->molecules[ti].AQ4 >0.0069) && (this->molecules[ti].AQ4 < 0.0567) )
      {
	if ((this->molecules[ti].AQ6 > 0.371) && (this->molecules[ti].AQ6 < 0.468) )
	  //{
	    //if (aq46Histo3d[get_HistoBox(this->molecules[ti].AQ4,a,b,n)][get_HistoBox(this->molecules[ti].AQ6,a,b,n)]>=0.0001)
	      { value = 1; }  else {value = 0;}
	//}
	  }
  }
...
int CMolecularSystem::fccclusterCriterium(int ti,int criterium)
{
  //double a,b;
  //int n;
  int value;
  ...
  if (criterium == 0)
  {
    if ((this->molecules[ti].AQ4 >0.112) && (this->molecules[ti].AQ4 < 0.199) )
      {
	if ((this->molecules[ti].AQ6 > 0.42)  && (this->molecules[ti].AQ6 < 0.549) )
	  //{
	    //if (aq46Histo3d[get_HistoBox(this->molecules[ti].AQ4,a,b,n)][get_HistoBox(this->molecules[ti].AQ6,a,b,n)]>=0.0001)
    { value = 1; }  else {value = 0;}
	//}
...
int CMolecularSystem::hcpclusterCriterium(int ti,int criterium)
{
  //double a,b;
  //int n;
  int value;
  ...
  if (criterium == 0)
  {
    if ((this->molecules[ti].AQ4 >0.056) && (this->molecules[ti].AQ4 < 0.112) )
      {
	if ((this->molecules[ti].AQ6 > 0.367) && (this->molecules[ti].AQ6 < 0.462))
	  //{
	    //if (aq46Histo3d[get_HistoBox(this->molecules[ti].AQ4,a,b,n)][get_HistoBox(this->molecules[ti].AQ6,a,b,n)]>=0.0001)
	      { value = 1; }  else {value = 0;}
	//}
...
int CMolecularSystem::get_greatestCluster(int criterium,int &greatestbelongsto)
{
  ...
  char IntStr[80];
  ofstream of;
  sprintf( IntStr, "./output/boundaryregion.dat");
  of.open (IntStr, ofstream::out | ofstream::trunc);
  if (of.is_open())
    {
      for (int ti= 0;ti<nop;ti++)
	{
	  if (this-> normaq46Histo3d[get_HistoBox(this->molecules[ti].AQ4,a,b,n)][get_HistoBox(this->molecules[ti].AQ6,a,b,n)]<= 0.1)
	    { of << this->molecules[ti].AQ4 <<"\t"<< this->molecules[ti].AQ6 <<""<< "\n"; }
	}
    }
  of.close();
  ...
  for (int ti= 0;ti<nop;ti++)
  {
   ...
   //cout << fcccluster <<""<< "\n";
   //cout << hccpluster <<""<< "\n";
  // cout << greatestcluster <<"\t"<< bcccluster<<"\t"<<fcccluster<<"\t"<<hcpcluster <<""<< "\n";
  /* give position of the cluster defect:
  int neigh;
  for (int ti= 0;ti<nop;ti++)
    {
      //if (this->molecules[ti].belongsto == greatestbelongsto)
      //{
      if (this->molecules[ti].id == 4400)
	  {
	    cout << this->molecules[ti].id << "\n";
	  for (int c = 0;c<this->molecules[ti].n_neighbors;c++)
	    {
	      neigh = this->molecules[ti].neighbors[c];
	      cout << this->molecules[neigh].id << "\n";
	    }
	  }
      //}
      }*/
...
void CMolecularSystem::outputSimpleResults(int number)
{
  ...
  if (of.is_open())
  {
    for (int ti=0;ti<this->parameter->nop;ti++)
    {
      of << molecules[ti].id << " "<<this->molecules[ti].AQ4  << " " << this->molecules[ti].AQ6 << "\n";
    }
  }
}
...
void CMolecularSystem::outputBondOrderHistogramms(int number)
{
  ...
  ofstream of;
  sprintf( IntStr, "q4Histo.%d.txt", number) ;
  of.open (IntStr, ofstream::out | ofstream::trunc);
  ...
  sprintf( IntStr, "q6Histo.%d.txt", number) ;
  of.open (IntStr, ofstream::out | ofstream::trunc);
  ...
  sprintf( IntStr, "aq4Histo.%d.txt", number) ;
  of.open (IntStr, ofstream::out | ofstream::trunc);
  ...
  sprintf( IntStr, "aq6Histo.%d.txt", number) ;
  of.open (IntStr, ofstream::out | ofstream::trunc);
  ...
  sprintf( IntStr, "q46Histo3d.%d.txt", number) ;
  of.open (IntStr, ofstream::out | ofstream::trunc);
  ...
  sprintf( IntStr, "aq46Histo3d.%d.txt", number) ;
  of.open (IntStr, ofstream::out | ofstream::trunc);
