...
class CMolecularSystem {
  private:
    ...
    //the cluster structure criterium, "Is this particle in hcp, bcc or fcc?"
    int fccclusterCriterium(int,int);
    int bccclusterCriterium(int,int);
    int hcpclusterCriterium(int,int);
